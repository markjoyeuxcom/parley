...
func checkReviewAndCorrectGuidanceIsDocumentedAsPractice() throws {
    ...
    try recipeExpect(AgentProtocol.version == "21", "recipe checks did not use the current shared protocol")
}
...
func checkReviewAndCorrectRequiresTwoTargetsFromDifferentVendors() throws {
    ...
    try recipeExpect(AgentProtocol.version == "21", "targeting checks did not use the current shared protocol")
}
