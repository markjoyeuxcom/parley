...
func checkReviewAndCorrectGuidanceIsDocumentedAsPractice() throws {
    ...
    try recipeExpect(AgentProtocol.version == "22", "recipe checks did not use the current shared protocol")
}
...
func checkReviewAndCorrectRequiresTwoTargetsFromDifferentVendors() throws {
    ...
    try recipeExpect(AgentProtocol.version == "22", "targeting checks did not use the current shared protocol")
}
