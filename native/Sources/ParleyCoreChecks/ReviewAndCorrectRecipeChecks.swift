...
func checkReviewAndCorrectGuidanceIsDocumentedAsPractice() throws {
    ...
    try recipeExpect(AgentProtocol.version == "25", "recipe checks did not use the current shared protocol")
}
...
func checkReviewAndCorrectRequiresTwoTargetsFromDifferentVendors() throws {
    ...
    try recipeExpect(AgentProtocol.version == "25", "targeting checks did not use the current shared protocol")
}
