            ...
            sections: [
                ParleyHelpSection(
                    ...
                    items: [
                        ...
                        "A file returned through `parley done current --file <path>` follows the same agent-provided boundary and appears both in the Context menu and on its completed handoff. The person may edit or discard it, add separately captured trusted sources, or choose whether to send the reviewed pack. Its compact completion receipt is never substituted for the file. After its draft is resolved or discarded, the returned file stays readable, unedited, from its completed handoff in Status Center (Show returned file) for as long as the coordination core keeps the resolved review, which retains the newest 100 records; reading it there is a complete interaction and needs no further send.",
