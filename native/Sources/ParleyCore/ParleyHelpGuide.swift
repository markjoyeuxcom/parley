            ...
            sections: [
                ParleyHelpSection(
                    ...
                    items: [
                        ...
                        "A file returned through `parley done current --file <path>` follows the same agent-provided boundary and appears both in the Context menu and on its completed handoff. The person may edit or discard it, add separately captured trusted sources, or choose whether to send the reviewed pack. Its compact completion receipt is never substituted for the file. A returned file stays readable on its completed handoff after its draft is discarded; reading it there is a complete interaction and needs no further send.",
